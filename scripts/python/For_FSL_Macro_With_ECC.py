...
if ( len ( sys.argv ) == 2 ) :
        ...
        if ( re.search ( "help$", cmdarg ) or re.match( '-h$', cmdarg ) ):
           s_1 = "Usage: For_FSL_Macro_With_Ecc.py -basedir <base_dir> -filename <name_from>"
...
for line in f:
    ...
    #print( line.strip() )
       ...
       if not ( os.path.isfile (  s_1p ) ):
          s_1p = s_1 + '4D.nii '
          s_1pp = s_1 + 'data'
          s1_cmd = '/usr/local/fsl/bin/eddy_correct ' + s_1p + s_1pp + ' 0'
          print ( s1_cmd )
...
#/usr/local/fsl/bin/eddy_correct /raid1/bboulat/FKBP_DICOMS/20180412_141027_529_1_1/9/pdata/1/processed/fsl_proc/4D.nii /raid1/bboulat/FKBP_DICOMS/20180412_141027_529_1_1/9/pdata/1/processed/fsl_proc/data 0
